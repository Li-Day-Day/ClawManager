...
func HandleError(c *gin.Context, err error) {
	...
	case "risk rule not found", "egress private exception not found", "instance not found":
		Error(c, http.StatusNotFound, errStr)
